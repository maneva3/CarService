...
(
    email TEXT PRIMARY KEY REFERENCES user (email)
);
...
(
    ...
    date_started   TEXT,
    date_finished  TEXT,
    price          REAL CHECK (price > 0 AND round(price, 2) = price),
    state          TEXT CHECK ( state IN ('COMPLETED', 'IN_PROGRESS', 'PENDING')) NOT NULL,
...
VALUES ('ivan-nikolov@gmail.com', 'BRAKE_REPAIR', '2022-02-01', '2022-02-02', 120.50, 'COMPLETED', 1),
       ('georgiev.g@gmail.com', 'OIL_CHANGE', '2024-03-05', '2024-03-06', 80.00, 'IN_PROGRESS', 2),
       ('p.dimitrov@gmail.com', 'DIAGNOSTICS', '2023-04-15', '2023-04-16', 150.25, 'COMPLETED', 3),
       ('stefanov92@mail.bg', 'WHEEL_ALIGNMENT', '2024-02-21', '2024-03-22', 90.75, 'IN_PROGRESS', 4),
       ('nikolan@mail.bg', 'ENGINE_DIAGNOSTICS', '2024-04-10', NULL, NULL, 'PENDING', 5),
       ('alexander.hr@abv.bg', 'PAINT_AND_BODY_WORK', '2024-03-25', NULL, NULL, 'PENDING', 6),
       ('petkov@gmail.com', 'FILTER_CHANGE', '2023-08-05', '2023-08-06', 65.80, 'COMPLETED', 7);